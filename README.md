...
https://img.shields.io/badge/C%252B%252B-23-blue.svg
...
✨ Features
    ...
    ✅ Modern C++ awareness – detects std::string, std::vector, <cstdint>, <memory> and adds required #includes
...
https://.github/screenshot.png <!-- You can place a real screenshot later -->
✨ Features
...
https://.github/terminal.gif <!-- Place a GIF or screenshot -->
text
